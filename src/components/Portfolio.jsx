...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      id: 'proj-2',
      category: 'agencies',
      title: 'Thumbsup Agency',
      audienceTag: 'Agency website',
      type: 'Agency Website & SEO Optimization',
      imageBg: 'from-cyan-900/40 to-slate-900',
      mockupHeader: 'thumbs-ups.com',
      problem: 'A Thumbnails agency needed a professional website that could highlight their services, expertise, and case studies',
      solution: 'Developed a modern, responsive agency website using React and Tailwind CSS. Implemented custom animations and interactive elements to showcase case studies and client success stories. Optimized the site for search engines to improve organic visibility and lead generation',
      result: 'Increased organic traffic by 75% and generated 40+ qualified leads for the agency',
      tech: ['React', 'Node.js', 'Tailwind CSS'],
      liveUrl: 'https://thumbs-ups.com/',
    },
    {
      id: 'proj-3',
      category: 'agencies',
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <div className="flex items-center gap-2 p-1.5 rounded-xl bg-slate-900 border border-slate-800 self-start md:self-auto">
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${activeFilter === 'all'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${activeFilter === 'freelancers'
                ? 'bg-emerald-500 text-slate-950 shadow-md'
                : 'text-slate-400 hover:text-white'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${activeFilter === 'agencies'
                ? 'bg-emerald-500 text-slate-950 shadow-md'
                : 'text-slate-400 hover:text-white'
                }`}
            >
