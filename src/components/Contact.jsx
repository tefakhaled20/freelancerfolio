          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              ...
              <p className="text-slate-400 text-base mt-2">
                Have a project in mind or want to discuss requirements? Send a message or schedule a 15-minute call directly.
              </p>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-slate-900 via-emerald-950/20 to-slate-900 relative overflow-hidden group">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Prefer to talk directly?</h3>
                  <p className="text-xs text-slate-300">Book a 15-Minute Strategy Call</p>
                </div>
              </div>
              
              <p className="text-xs text-slate-400 mb-6 leading-relaxed">
                Skip the back-and-forth email exchange. Pick a time on my interactive calendar for a live Zoom consultation.
              </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="Freelancer Portfolio">Freelancer Portfolio / Personal Brand</option>
                        <option value="Business Website">Business Website / Custom Web App</option>
                        <option value="E-Commerce / Booking">E-Commerce / Booking Engine</option>
                        <option value="Ongoing Maintenance">Ongoing Maintenance & Support</option>
